...
async function fetchWorker() {
  try {
    ...
    const profileId = resolveWorkerProfileId(worker.value);
    await enrichTelegramFields(profileId);
  } catch (err) {
              ...
              <div class="w-full space-y-2 text-sm text-left border-t pt-4">
                ...
                <div class="flex items-center gap-4 text-gray-600 mt-4 pt-3 border-t flex-wrap justify-around">
                  <button
                    ...
                    class="flex items-center justify-center gap-2 text-[#229ED9] hover:text-[#1b8bc0] font-medium text-sm transition-colors"
                  >
